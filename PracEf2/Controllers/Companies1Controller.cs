...
namespace PracEf2.Controllers
{
    public class Companies1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CompanyId,CompanyName,place")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CompanyId,CompanyName,place")] Company company)
        {
            if (ModelState.IsValid)
            {
